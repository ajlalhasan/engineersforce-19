...
class TestPurchaseRequestProcurement(common.TransactionCase):
    ...
    def test_orderpoint(self):
        ...
        self.env["stock.procurement.group"].run_scheduler()
        self.assertEqual(
    ...
    def test_procure_purchase_request_with_fixed_group(self):
        ...
        NOTE: This test is disabled for Odoo 19 as procurement.group model
        no longer exists.
        """
        # Test disabled for Odoo 19 - procurement.group model removed
        pass
